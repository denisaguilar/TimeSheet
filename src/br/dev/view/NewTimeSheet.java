...
public class NewTimeSheet {
	...
	public boolean showDialog() {
		...
		textClockUpdate.addFocusListener(new FocusAdapter() {
		...
		textUpdate.addKeyListener(new KeyListenerLimit(2, textClockUpdate));
		textUpdate.addFocusListener(new FocusAdapter() {
		...
		textTimeIdleS.addKeyListener(new KeyListenerLimit(2, textUpdate));
		...
		textTimeIdleM.addKeyListener(new KeyListenerLimit(2, textTimeIdleS));
		...
		textTimeIdleH.addKeyListener(new KeyListenerLimit(2, textTimeIdleM));
		...
		textTimeSeconds.addKeyListener(new KeyListenerLimit(2, textTimeIdleH));
		...
		textTimeMinute.addKeyListener(new KeyListenerLimit(2, textTimeSeconds));
		...
		textTimeHour.addKeyListener(new KeyListenerLimit(2, textTimeMinute));
